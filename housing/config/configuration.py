from housing.entity.config_entity import DataIngestionConfig, DatavalidationConfig, DataTransformtionConfig, ModelTrainingConfig, ModelEvaluationConfig, ModelPusherConfig, TrainingPipelineConfig
...
class Configuration:
    ...
    # this function is use for data ingestion config
    ...
    # this functions is use for getting artifact_dir from  config for training pipeline
